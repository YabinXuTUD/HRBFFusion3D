...
class GPUConfig
{
    ...
    private:
           ...
           so3StepBlocks(64)
        {
            ...
            icpStepMap["Quadro M2000"] = std::pair<int, int>(256, 48);
            rgbStepMap["Quadro M2000"] = std::pair<int, int>(128, 32);
            rgbResMap["Quadro M2000"] = std::pair<int, int>(256, 48);
            so3StepMap["Quadro M2000"] = std::pair<int, int>(128, 48);

            icpStepMap["GeForce RTX 2070"] = std::pair<int, int>(96, 144);
            rgbStepMap["GeForce RTX 2070"] = std::pair<int, int>(416, 32);
            rgbResMap["GeForce RTX 2070"] = std::pair<int, int>(176, 464);
            so3StepMap["GeForce RTX 2070"] = std::pair<int, int>(320, 32);

            icpStepMap["GeForce RTX 2060"] = std::pair<int, int>(96, 144);
            rgbStepMap["GeForce RTX 2060"] = std::pair<int, int>(416, 32);
            rgbResMap["GeForce RTX 2060"] = std::pair<int, int>(176, 464);
            so3StepMap["GeForce RTX 2060"] = std::pair<int, int>(320, 32);
